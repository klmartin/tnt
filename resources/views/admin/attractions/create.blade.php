          ...
          <div class="card-body">
            <form method="POST" action="{{ route('attractions.store') }}" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="file" name="photos[]" id="photos" class="form-control {{ $errors->has('photos') ? 'is-invalid' : '' }}" multiple accept="image/*">
...
<script>
   Dropzone.options.photosDropzone = {
        url: "{{ route('attractions.store') }}", // URL to handle uploads
        method: "post",
